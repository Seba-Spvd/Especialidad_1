...
def listar_producto(request):
    ...
    return render(request, 'product/listar_producto.html', {'productos': productos, 'buscar': busqueda})
...
def agregar_producto(request):
    ...
    return render(request, 'product/agregar_producto.html', data)
...
def actualizar_producto(request, id):
    ...
    return render(request, 'product/actualizar_producto.html',data)
@login_required
...
def ejemplos_carga_masiva_save(request):
    ...
    if request.method == 'POST':
        ...
        return redirect('ejemplos_carga_masiva_save')    
#####################################